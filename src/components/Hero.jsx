...
import cvFile from '../cv/Luciano Nicolas Lopez Gonzalez ENG.pdf';
import '../index.css';
        ...
        <section id="hero" className="section" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            <div className="container">
                ...
                <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <a href={cvFile} download="Luciano_Lopez_CV.pdf" className="btn-secondary" style={{ border: '1px solid var(--accent-primary)' }}>
                        {t.download_cv}
                    </a>
                </div>
            </div>
